    ...
    try:
        ...
        for sig in tx_sigs:
            ...
            if buyer_address:
                ...
                # create ata
                try:
                    token.get_account_info(ata) # this call error if the ata has not yet been created
                    ...
                    # here we create the ata, but this call often crashes and is slow so we just call it then come back to it next round
